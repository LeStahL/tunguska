...
int WINAPI demo(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)
{
	...
	// Add mute checkbox
	HWND hMuteCheckbox = CreateWindow(WC_BUTTON, "Mute", WS_VISIBLE | WS_CHILD | BS_CHECKBOX, 10, 40, 100, 20, lwnd, (HMENU)6, hInstance, NULL);
	...
	HWND hFSAAComboBox= CreateWindow(WC_COMBOBOX, "", CBS_DROPDOWN | CBS_HASSTRINGS | WS_CHILD | WS_OVERLAPPED | WS_VISIBLE, 100, 60, 175, 280, lwnd, (HMENU)8, hInstance, NULL);
	...
	const char *fsaa1= "None",
		...
		*fsaa16 = "16*FSAA",
		*fsaa25 = "25*FSAA";
	SendMessage(hFSAAComboBox, CB_ADDSTRING, 0, fsaa1);
	SendMessage(hFSAAComboBox, CB_ADDSTRING, 0, fsaa4);
	SendMessage(hFSAAComboBox, CB_ADDSTRING, 0, fsaa9);
	SendMessage(hFSAAComboBox, CB_ADDSTRING, 0, fsaa16);
	SendMessage(hFSAAComboBox, CB_ADDSTRING, 0, fsaa25);
	...
	HWND hTXAAComboBox= CreateWindow(WC_COMBOBOX, "", CBS_DROPDOWN | CBS_HASSTRINGS | WS_CHILD | WS_OVERLAPPED | WS_VISIBLE, 100, 90, 175, 280, lwnd, (HMENU)9, hInstance, NULL);
	...
	const char *buf128= "128^2 px",
		...
		*buf512 = "512^2 px",
		*buf1024 = "1024^2 px";
	SendMessage(hTXAAComboBox, CB_ADDSTRING, 0, buf128);
	SendMessage(hTXAAComboBox, CB_ADDSTRING, 0, buf256);
	SendMessage(hTXAAComboBox, CB_ADDSTRING, 0, buf512);
	SendMessage(hTXAAComboBox, CB_ADDSTRING, 0, buf1024);
	...
	// Add scene selector
	HWND hSceneComboBox = CreateWindow(WC_COMBOBOX, "", CBS_DROPDOWN | CBS_HASSTRINGS | WS_CHILD | WS_OVERLAPPED | WS_VISIBLE, 100, 120, 175, 280, lwnd, (HMENU)10, hInstance, NULL);
